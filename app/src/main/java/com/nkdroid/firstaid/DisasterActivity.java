...
public class DisasterActivity extends ActionBarActivity implements BaseSliderView.OnSliderClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        postArrayList.add("Chemical Emergencies");
        postArrayList.add("Drought");
        postArrayList.add("Earthquake");

        postArrayList.add("Fire");
        postArrayList.add("Flooding");
        postArrayList.add("Heatwave");
        ...
        postAdapter = new PostAdapter(DisasterActivity.this, postArrayList);
    ...
    private void setToolbar() {
        ...
        if (toolbar != null) {
            toolbar.setTitle("Natural disaster");
...
//            holder.txtPostDescription.setText(postArrayList.get(position).getDescription());
            ...
            Glide.with(DisasterActivity.this)
...
//                    Intent intent1 = new Intent(DisasterActivity.this, Tip1Activity.class);
...
//        url_maps.put("Game of Thrones", "http://images.boomsbeat.com/data/images/full/19640/game-of-thrones-season-4-jpg.jpg");
        ...
        file_maps.put("Flood",R.drawable.flood);
        file_maps.put("Earthquake",R.drawable.earthquake);
        file_maps.put("Drought",R.drawable.drought);
        file_maps.put("Fire", R.drawable.fire);
